...
function AlumnoRegistro({ mostrarFormulario, setMostrarFormulario, datos, setDatos }) {
                ...
                <div className="modal-overlay">
                    <div className="modal">
                        ...
                        <form onSubmit={handleRegistrar}>
                            ...
                            <button type="submit">Registrar Alumno</button> <br />
