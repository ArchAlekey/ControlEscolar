...
public interface ProfesoresRepository extends JpaRepository<AcademicosProfesores, Integer> {
        ...
        void insertaCalificaciones(@Param("IntIdMateria") Integer nid_materia, @Param("IntIdUsuario") Integer nid_usuario, @Param("FloatCalificacion") Float ncalificacion);

        //Procedimiento SPD_CONSULTA_ALUMNOS_INSCRITOS
        @Procedure(procedureName = "SPD_CONSULTA_ALUMNOS_INSCRITOS")
        List<Object[]> consultaAlumnosIns(@Param("IntIdGrupo") Integer nid_grupo);
