...
CREATE PROCEDURE SPD_INSERTA_PERSONA_PROFESOR
(
...
BEGIN
    ...
    SET @NumCuenta = CONCAT('20', SUBSTRING(StrCURP, 1, 10));
    ...
    VALUES
    (@nid_persona , 2, IntIdCarrera, @NumCuenta , CONCAT(@NumCuenta , '@controlescolar.com'), StrCorreoPersonal, 1, NOW());
