...
BEGIN
    ...
    INSERT INTO tbl_academicos_alumnos(nid_persona, nid_categoria, nid_carrera, cnumero_cuenta, ccorreo_institucional, ccorreo_personal, bhabilitado, dfecha_alta)
    VALUES
    (@nid_persona , 1, IntIdCarrera, @NumCuenta , CONCAT(@NumCuenta , '@controlescolar.com'), StrCorreoPersonal, 1, NOW());
