...
CREATE PROCEDURE SPD_INSERTA_PERSONA_SUPER_US
(
...
BEGIN
    ...
    SET @NumCuenta = CONCAT('40', SUBSTRING(StrCURP, 1, 10));

    INSERT INTO tbl_academicos_super_us(nid_persona, nid_categoria, nid_carrera, cnumero_cuenta, ccorreo_institucional, ccorreo_personal, bhabilitado, dfecha_alta)
    VALUES
    (@nid_persona , 4, 9, @NumCuenta , CONCAT(@NumCuenta , '@controlescolar.com'), StrCorreoPersonal, 1, NOW());
